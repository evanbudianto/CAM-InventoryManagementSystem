...
<ul class="nav nav-tabs">
	<li class="active"><a href="#tab-first" id="btn-sale-archive" data-toggle="tab">Request List</a></li>
	<!--<li><a href="#tab-second" id="btn-cashsale-archive" data-toggle="tab">Cash Sale Archive</a></li>-->
    <li><a href="#tab-third" id="btn-sale-add" data-toggle="tab">Create New Request</a></li>
</ul>
	...
	<tr>
		...
		<td>{{RequestStatus}}</td>
  		...
  		<td>
			...
			<p>Service Charge: Rp {{ServiceCharge}}</p>
			<p>Total Discount: Rp {{TotalDiscount}}</p> -->
