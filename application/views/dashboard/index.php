		...
		<div class="widget">
			...
			<div class="widget-body">
				<ul class="cpanel">
					...
					<li><a class="button2" href="<?=site_url('user')?>">Administrator</a></li>
					<li><a class="button3" href="<?=site_url('customer')?>">Requester</a></li>
					<li><a class="button4" href="<?=site_url('inventory')?>">Inventory</a></li>
					<li><a class="button5" href="<?=site_url('invoice')?>">Request</a></li>
				</ul>
			</div>
		</div>
	</div>
...
<div class="widget">
	<div class="widget-header"><h4>Bar Chart - Request By Year</h4></div>
	<div class="widget-body">
