...
<ul class="nav nav-tabs">
	<li class="active"><a data-target="#customer" data-toggle="tab">Requester</a></li>
    <li><a data-target="#customer-invoice" data-toggle="tab">Request Log</a></li>
</ul>
	...
	{{#if customer}}
		{{#customer}}
			<div class="block">
				...
				<h4><address>Department: {{{Address}}}</address></h4>
	...
	function renderCustomer() {
		...
		$.fetchRemoteData('customer', 'getCustomer', form_data).then(function (data) {
			customer = {
			    ...
			    Department: data.customer[0].Address,
