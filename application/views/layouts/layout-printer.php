    ...
    <body>
		<div class="container printer">
			...
			<div class="row-fluid">
				...
				<div class="span5">
					<small>Department: <?=$CustomerAddress?></small>
				</div>
			</div>
			<hr style="margin-top: 0px;" />
			<table class="table table-condensed table-bordered">
				<thead>
			  		<tr>
						...
						<th style="text-align: center;">Unit Price (Rp)</th>
				...
				<tbody>
					...
					<!-- <tr>
						...
						<td style="text-align: right;">Rp <?=$TotalCost?></td>
					</tr>
					<tr>
						<td colspan="6" style="text-align: right;">Service Charge / Installation</td>
						<td style="text-align: right;">Rp <?=$ServiceCharge?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="text-align: right;">Rp <?=$TotalDiscount?></td>
					</tr> -->
					<tr>
						<th colspan="6" style="text-align: right;">Grand Total</th>
						<th style="text-align: right;">Rp <?=$GrandTotal?></th>
					</tr>
				</tbody>
			</table>
			<div class="row-fluid">
