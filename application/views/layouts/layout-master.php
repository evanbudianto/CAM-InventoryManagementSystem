...
<html lang=en>
    ...
    <body>
			...
			<div class="navbar-inner" style="padding-left: 10px;padding-right: 10px;">
            	<div class="container-fluid">
                    ...
                    <a class="brand" href="<?=site_url('welcome')?>">
                        CAM Inventory Management System
                        <span class="label label-success">TELKOMSEL</span>
                    </a>
                    ...
                    <div class="nav-collapse">
						<ul class="nav">
							...
							<li class="<?=active_url_class('user')?>"><a href="<?=site_url('user')?>">Administrator</a></li>
                            <li class="<?=active_url_class('customer')?>"><a href="<?=site_url('customer')?>">Requester</a></li>
                            <li class="<?=active_url_class('inventory')?>"><a href="<?=site_url('inventory')?>">Inventory</a></li>
							<li class="<?=active_url_class('invoice')?>"><a href="<?=site_url('invoice')?>">Request</a></li>
						</ul>
					</div><!--/.nav-collapse -->
				</div>
        	</div>
		...
		<div class="container">
			...
			<p class="pull-right">
            	<!--Copyright &copy;
           		<?=(2017 == date('Y')) ? 2017 : "2017 &#8211; " . date('Y')?>
                <a href="#" target="blank">CAM</a>. All rights reserved.
                -->
			</p>
        </div>
